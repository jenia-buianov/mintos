...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit(event) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post($('#login-form-from').attr('action'), this.form).then(function (response) {
...
Vue.component('login-form', __webpack_require__(/*! ./components/login */ "./resources/js/components/login.vue")["default"]);
var app = new Vue({
  el: '#login-form'
});
...
module.exports = __webpack_require__(/*! /var/www/html/mintos/resources/js/login.js */"./resources/js/login.js");
